...
export const FafipaTopicAnalysisModal: React.FC<FafipaTopicAnalysisModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[120] bg-black/60 backdrop-blur-md flex items-start justify-center p-2 sm:p-6 pt-2 sm:pt-6 overflow-y-auto">
            <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 rounded-2xl sm:rounded-3xl w-full max-w-xl overflow-hidden shadow-2xl flex flex-col max-h-[92dvh] sm:max-h-[88vh] my-1 sm:my-4 animate-scale-up">
