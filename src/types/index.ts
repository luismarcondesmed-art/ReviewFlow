...
export type AreaType = 'geral' | 'tecnico' | 'idiomas' | 'exatas' | 'humanas';
...
export interface Topic {
  ...
  targetTrack?: 'residencia' | 'concurso' | 'geral'; // Concurso vs Residência vs Geral
}
...
export interface UserConfig {
  ...
  activeSchedule?: 'MEDCOF' | 'ESTRATEGIA' | 'MEDREVIEW' | 'FAFIPA'; // Added preference
  ...
  studyTrack?: 'all' | 'residencia' | 'concurso'; // Study track focus filter
  userIcon?: string; // User-selected avatar icon
}
