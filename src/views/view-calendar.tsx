                                                            ...
                                                            {topic?.linkedLessons && topic.linkedLessons.length > 0 && (
                                                                <div className="flex flex-wrap gap-1 mt-1.5">
                                                                    {topic.linkedLessons.map((c: string, i: number) => (
                                                                        <span key={i} className="text-[9px] font-bold bg-slate-100 dark:bg-white/10 text-slate-500 dark:text-slate-400 px-1.5 py-0.5 rounded uppercase tracking-wider">
                                                                            {c}
                                                                        </span>
                                                                    ))}
                                                                </div>
