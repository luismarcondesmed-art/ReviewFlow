                ...
                <div className="flex flex-col gap-6 animate-fade-in">
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 rounded-[24px] p-4 lg:p-6 shadow-sm flex flex-col gap-4 relative overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10 w-full mb-2">
                                ...
                                <div className="flex bg-slate-100 dark:bg-zinc-800 p-1 rounded-xl w-full md:w-auto shrink-0 border border-slate-200/50 dark:border-white/5">
                                    ...
                                    {config.studyLink && (
                                        <a 
                                            ...
                                            className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-900 dark:bg-white text-white dark:text-black rounded-lg font-bold text-xs shadow-sm active:scale-95 transition-all outline-none md:ml-2 mt-1 md:mt-0"
                            ...
                            {dueItems.length === 0 && config.studyLink && (
                                <div className="w-full md:w-auto">
                                   <a 
                                        href={config.studyLink} 
                                        target="_blank" 
                                        rel="noopener noreferrer"
                                        className="flex items-center justify-center gap-2 px-4 py-3 bg-slate-900 dark:bg-white text-white dark:text-black rounded-xl font-bold text-xs shadow-md shadow-slate-900/20 active:scale-95 transition-all outline-none"
                                        style={{ textDecoration: 'none' }}
                                    >
